 ...
 * @ORM\Entity(repositoryClass="AdminBundle\Repository\ContentBlockRepository")
 */
class ContentBlock
{
    /**
     ...
     * 
     * @ORM\OneToMany(targetEntity="ContentBlockImage", mappedBy="block", cascade={"persist", "remove"})
